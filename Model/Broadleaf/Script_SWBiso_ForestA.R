...
inp <- read.csv("Demnitz_inpmod_Fo.csv",na.strings="", sep = ",")     		    # read input into dataframe from .csv file with , as decimal separator
...
observed<- read.csv("Demnitz_inpmod_Fo.csv", sep = ",")
