...
#   return (cbind(output))
  ...
  # Time-series output variables as a matrix
  time_series_output <- cbind(
    SCF = SCF[367:nrun], D = D[367:nrun],
    Qs = Qs[367:nrun], Th = Th[367:nrun],
    PN = PN[367:nrun], I = I[367:nrun],
    Ei = Ei[367:nrun], Es = Es[367:nrun],
    Tr = Tr[367:nrun], Tr_Upper = Tr_Upper[367:nrun],
    Tr_Lower = Tr_Lower[367:nrun], Tr_Deep = Tr_Deep[367:nrun],
    Perc = Perc[367:nrun], Pref_Flow = Pref_Flow[367:nrun],
    Recharge = Recharge[367:nrun], GWflow = GWflow[367:nrun],
    STO = STO[367:nrun], GW = GW[367:nrun],
    Sdeep = Sdeep[367:nrun], Int_CD = Int_CD[367:nrun],
    Idl_H = Idl_H[367:nrun], fInt_CD = fInt_CD[367:nrun],
    upCSTO_D = upCSTO_D[367:nrun], Sdl_H = Sdl_H[367:nrun],
    fupCSTO_D = fupCSTO_D[367:nrun], gwCQ_D = gwCQ_D[367:nrun],
    lowCQ_D = lowCQ_D[367:nrun]
  )

  return(time_series_output)  # Return as a matrix
